import{C as l,e as o}from"./marketplaceApi.DWbYmQmP.js";import"./hoisted.VIaS4Poc.js";let r=[],a="";function m(e){return Number(e||0).toLocaleString("ar-EG")+" ج.م"}function n(){const e=document.getElementById("mkt-search").value.trim().toLowerCase();let i=r;a&&(i=i.filter(t=>t.category===a)),e&&(i=i.filter(t=>t.title.toLowerCase().includes(e)||(t.description||"").toLowerCase().includes(e))),document.getElementById("mkt-count").textContent=String(i.length);const s=document.getElementById("mkt-grid");if(!i.length){s.innerHTML='<div class="no-results"><div class="no-results__icon">🔍</div><p>لا توجد إعلانات مطابقة</p></div>';return}s.innerHTML=i.map(t=>`

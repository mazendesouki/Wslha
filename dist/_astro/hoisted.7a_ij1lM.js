import{C as l,a as o}from"./marketplaceApi.BAgn7257.js";import"./hoisted.VIaS4Poc.js";let r=[],i="";function m(e){return Number(e||0).toLocaleString("ar-EG")+" ج.م"}function n(){const e=document.getElementById("mkt-search").value.trim().toLowerCase();let a=r;i&&(a=a.filter(t=>t.category===i)),e&&(a=a.filter(t=>t.title.toLowerCase().includes(e)||(t.description||"").toLowerCase().includes(e))),document.getElementById("mkt-count").textContent=String(a.length);const s=document.getElementById("mkt-grid");if(!a.length){s.innerHTML='<div class="no-results"><div class="no-results__icon">🔍</div><p>لا توجد إعلانات مطابقة</p></div>';return}s.innerHTML=a.map(t=>`

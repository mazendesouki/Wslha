-- =====================================================================
--  وصّلها — تعديل سعر الرحلات الخارجية: 25 → 7 ج.م/كم (سيدان)
--
--  سعر الكيلومتر الأساسي (سيدان)، وSUV/الفان أعلى بنسبة ثابتة (+30% / +40%):
--    داخلي (داخل دمياط)          8  ج.م/كم  →  SUV 10.4  •  فان 11.2   (بدون تغيير)
--    خارجي (خارج محافظة دمياط)   7  ج.م/كم  →  SUV 9.1   •  فان 9.8    (كان 25)
--    مطار (لسه بيُحسب في الواجهة فقط، بلا إعادة حساب هنا — زي ما كان)
--
--  ⚠️ يجب أن يطابق TRIP_RATES في src/data/airports.ts.
